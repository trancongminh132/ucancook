...
{ 
	...
	public final static function getInstance($options = array())
	{
		...
		if(empty($className))
		{
			throw new My_Zend_Cache_Exception("No instance of empty class when call My_Zend_Cache_Profiler");
		}
		...
		{
			case 'html':				
				$className = 'My_Zend_Cache_Profiler_Adapter_Html';
				break;
			default:
