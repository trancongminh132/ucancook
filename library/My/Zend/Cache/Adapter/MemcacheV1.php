<?php
class My_Zend_Cache_Adapter_MemcacheV1 extends My_Zend_Cache_Adapter_Abstract
{
    /**
	 * Memcache object
	 *
    ...
    {
    	//Get memcache option
    	$mem_options = $options['memcachev1'];
        ...
        if($this->log)
        {
    		...
    		if(empty($mem_options['logger']['path']))
    		{
    			throw new My_Zend_Cache_Exception('Input Logdir for Memcache.');
    		}
    		
    		//Get logger
    		$logger = new My_Zend_Logger($mem_options['logger']['path']);
