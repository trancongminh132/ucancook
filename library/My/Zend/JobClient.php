...
class My_Zend_JobClient
{
   /**
	...
	public final static function getInstance($options = array())
	{
		...
		if(empty($className))
		{
			throw new My_Zend_Job_Exception("No instance of empty class when call My_Zend_JobClient");
		}
		...
		{
			case 'gearman':				
				$className = 'My_Zend_Job_Adapter_Gearman_Client';
				break;
			default:
